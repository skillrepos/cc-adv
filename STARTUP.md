...
**Action:** Open a **new** terminal — click the **+** at the top right of the terminal panel, or use *Terminal → New Terminal*.
...
/model
```
First, use the left/right arrow keys to change the effort to *Medium effort*. 
